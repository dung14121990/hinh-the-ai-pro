...
const femaleOutfitsContainer = document.getElementById('female-outfits');
const maleOutfitsContainer = document.getElementById('male-outfits');
const outfitPresetBtns = document.querySelectorAll('.outfit-btn');

const accessoriesInput = document.getElementById('accessories-input');
const makeupFieldset = document.getElementById('makeup-fieldset');
const makeupRadios = document.querySelectorAll('input[name="makeup"]');

const femaleHairContainer = document.getElementById('female-hair');
const maleHairContainer = document.getElementById('male-hair');
const hairRadios = document.querySelectorAll('input[name="hair"]');

const keepHairCheckbox = document.getElementById('keep-hair-checkbox');
const smoothSkinCheckbox = document.getElementById('smooth-skin-checkbox');
const smileCheckbox = document.getElementById('smile-checkbox');

const similaritySlider = document.getElementById('similarity-slider');
const similarityValueLabel = document.getElementById('similarity-value-label');
...
function handleGenderChange(newGender) {
    ...
    if (isFemale) {
        ...
        if (defaultHair) defaultHair.checked = true;
        state.hair = defaultHair?.value || 'kiểu tóc tự nhiên, gọn gàng';
    } else {
        // Set male defaults
        ...
        if (defaultHair) defaultHair.checked = true;
        state.hair = defaultHair?.value || 'kiểu tóc nam tự nhiên, gọn gàng';
    }
...
function setupEventListeners() {
    ...
    // Direct listener on the file input for clicks and keyboard activation
    ...
    genderRadios.forEach(radio => radio.addEventListener('change', () => handleGenderChange(radio.value)));
